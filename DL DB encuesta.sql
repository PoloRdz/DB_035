...
/****** Object:  Database [ENCUESTA]    Script Date: 3/8/2020 10:05:44 PM ******/
...
CREATE DATABASE [ENCUESTA]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ENCUESTA', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\ENCUESTA.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ENCUESTA_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\ENCUESTA_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ENCUESTA] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [ENCUESTA] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [ENCUESTA] SET QUERY_STORE = OFF
GO
